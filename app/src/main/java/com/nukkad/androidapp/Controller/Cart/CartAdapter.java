package com.nukkad.androidapp.Controller.Cart;
...
import com.nukkad.androidapp.View.Checkout.DeliveryDataActivity;
import com.nukkad.androidapp.View.SignInActivity;
...
public class CartAdapter extends BaseExpandableListAdapter{
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (currProduct.GetManufacturerName() != null)
            label = String.format("%s: %s", currProduct.GetManufacturerName(), currProduct.GetTitle());
        else
