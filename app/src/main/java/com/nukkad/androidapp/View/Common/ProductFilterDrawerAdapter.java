 ...
 */
public class ProductFilterDrawerAdapter extends RecyclerView.Adapter<ProductFilterDrawerAdapter.ViewHolder> {
    ...
    public ProductFilterDrawerAdapter(String[] data) {
        mData = data;
    }
    ...
    @Override
    public ProductFilterDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_product_filter_drawer_row, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(ProductFilterDrawerAdapter.ViewHolder viewHolder, final int i) {
