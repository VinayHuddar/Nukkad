...
package com.nukkad.androidapp.Utilities;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbDisabledImage = BitmapFactory.decodeResource(getResources(),
            R.drawable.seek_thumb_normal); //R.drawable.seek_thumb_disabled);
    ...
    private boolean mShowThumbLabels = true;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mRectLineHeight = PixelUtil.dpToPx(context, LINE_HEIGHT_IN_DP);
        float topDistance = thumbHalfHeight - mRectLineHeight / 2 + (mShowThumbLabels ? mTextOffset : 0);
        float bottomDistance = thumbHalfHeight + mRectLineHeight / 2 + (mShowThumbLabels ? mTextOffset : 0);
    ...
    public void showThumbLabels (boolean showThumbLabels) {
        mShowThumbLabels = showThumbLabels;
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        float minMaxHeight = (mShowThumbLabels ? mTextOffset : 0) + thumbHalfHeight + mTextSize / 3;
        ...
        mRect.offsetTo(padding, thumbHalfHeight - mRectLineHeight / 2 + (mShowThumbLabels ? mTextOffset : 0));
        ...
        mRect.offsetTo(normalizedToScreen(normalizedMinValue), thumbHalfHeight - mRectLineHeight / 2 + (mShowThumbLabels ? mTextOffset : 0));
    ...
    private void drawThumb(float screenCoord, boolean pressed, Canvas canvas, boolean areSelectedValuesDefault) {
        ...
        canvas.drawBitmap(buttonToDraw, screenCoord - thumbHalfWidth,
                (mShowThumbLabels ? mTextOffset : 0),
                paint);
    }
